...
| `CENTAUR_SANDBOX_TOKEN_TTL_S` | `api.extraEnv`. | Lifetime for API-issued sandbox bearer tokens. Set this at least as high as `IDLE_TTL_S` for long-lived threads. Defaults to `7200`. |
