...
@app.command("health")
def health():
    """Assert mpp configuration without making a paid data request."""
    ...
    try:
        ...
        details = {
            "credential": "MPP_PRIVATE_KEY",
            "network_check": "skipped_paid_mpp_query",
            "daily_spend_cap_usd": client._daily_cap,
        }
